document.getElementById("scan-button").addEventListener("click", async () => {
    try {
        // Ensure Dynamsoft is fully loaded before using it
        if (typeof Dynamsoft === "undefined" || !Dynamsoft.BarcodeReader) {
            alert("Error: Dynamsoft library failed to initialize. Please refresh and try again.");
            console.error("Dynamsoft is not available in index.js.");
            return;
        }
        ...
        // Set barcode formats (including all VIN barcode types)
